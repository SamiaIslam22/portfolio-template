...
const ProjectsSection = ({ isAnimating }: ProjectsSectionProps) => {
  ...
  return (
    <motion.section
      className="min-h-screen pt-24 pb-12 px-4 flex flex-col items-center justify-center"
    ...
    >
      <div className="w-full max-w-[90rem]">
        ...
        >
          <h2 className="font-mono text-lg md:text-2xl font-bold text-blue-400 mb-2">
        ...
        >
          <div className="flex bg-gray-900/50 backdrop-blur-sm rounded-lg p-2 border border-blue-400/30">
        ...
        <div className="relative">
          ...
          <AnimatePresence mode="wait">
            <motion.div
              key={currentIndex}
              className="bg-gray-900/90 backdrop-blur-sm border border-blue-400/50 rounded-xl p-10 min-h-[350px]"
            ...
            >
              ...
              <div className="flex flex-col lg:flex-row gap-8 mb-4">
                ...
                <div className="flex-1">
                  ...
                  {/* Tech Stack - moved up */}
                  <div className="mb-4">
                    <h4 className="text-blue-400 font-mono font-semibold mb-3 text-sm uppercase tracking-wide">
                      Tech Stack
                    </h4>
                    <div className="flex flex-wrap gap-2">
                      {currentProject.tech.map((tech, i) => (
                        <motion.span
                          key={i}
                          className="bg-blue-400/20 text-blue-300 px-3 py-1 rounded-lg text-sm font-mono"
                  ...
                  {/* Brief Description */}
                  <div className="mb-4">
                    <h4 className="text-blue-400 font-mono font-semibold mb-2 text-sm uppercase tracking-wide">
                      Project Brief
                    </h4>
                  ...
                  {/* Key Highlights - moved inside left column */}
                  <div className="mb-6">
                    <h4 className="text-blue-400 font-mono font-semibold mb-3 text-sm uppercase tracking-wide">
                      Key Highlights
                    </h4>
                ...
                <div className="flex-shrink-0 w-full lg:w-[750px] flex items-start justify-center pt-28">
                  <div className="bg-gray-800/50 border border-blue-400/30 rounded-lg p-4 w-full max-w-2xl flex items-center justify-center">
                    {currentProject.id === 1 && (
                      <img 
                        src="/project1.png" 
                        alt="UCSB RAG Chatbot System Screenshot"
                        className="w-full h-auto object-contain rounded-lg max-h-[24rem]"
                      />
                    )}
                    {currentProject.id === 2 && (
                      <img 
              ...
              <div className="flex gap-4">
                {currentProject.github && (
                  <motion.a
                    ...
                    className="flex items-center gap-2 bg-gray-800 hover:bg-gray-700 px-6 py-3 rounded-lg text-blue-400 transition-all duration-300 hover:shadow-lg hover:shadow-blue-400/20"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                ...
                {currentProject.demo && (
                  <motion.a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 bg-blue-400/20 hover:bg-blue-400/30 px-6 py-3 rounded-lg text-blue-400 transition-all duration-300 hover:shadow-lg hover:shadow-blue-400/20"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
